...
public class RequestService : IRequestService
{
    ...
    public RequestService(ApplicationDbContext dbContext, IRedisCacheService redisCacheService)
    {
        _dbContext = dbContext;
        _redisCacheService = redisCacheService;
    }

    public async Task<string> RequestRedirect(string guid, string scope)
    {
